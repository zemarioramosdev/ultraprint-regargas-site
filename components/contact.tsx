              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">(31) 3333-3333</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contato@ultraprint.com.br</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Rua das Impressoras, 123 - Centro, BH - MG</p>
                  </div>
                </div>
